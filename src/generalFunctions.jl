...
"""
function get_random_value(probDistribution::String; lower::Float64=0.0, upper::Float64=1.0, μ::Float64=0.0, σ::Float64=1.0, θ::Float64=1.0)
...
"""
function get_sample_mean(N::Int64; probDistribution::String="uniform", lower::Float64=0.0, upper::Float64=1.0, μ::Float64=0.0, σ::Float64=1.0, θ::Float64=1.0)
...
"""
function get_sample_mean_mean(N::Int64, sampleRuns::Int64; probDistribution::String="uniform", lower::Float64=0.0, upper::Float64=1.0, μ::Float64=0.0, σ::Float64=1.0, θ::Float64=1.0)
    results = Vector{Float64}() # empty vector to store results 
